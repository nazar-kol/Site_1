...
<body>
	<br><br><br>
	<h3 class="welcome">Список постраждалих та докладна інформація про них</h3><br>

	<div class="row"></div>
	<div class="row">
		<div class="col-sm-3 col_1_3"><br>
			<?php 
			require_once('vic_list.php');
			?>
		...
		<div class="col-sm-6 col_2"><br>
			...
			if(!empty($_GET['id'])){
				$id=$_GET['id'];
				$sql="SELECT * FROM victims WHERE victim_code='$id'";
				$res=mysqli_query($connect,$sql);
				$result=mysqli_fetch_assoc($res);
				$vic_pipp=$result['vic_pip'];
				$vic_birthh=$result['vic_birth'];
				$vic_sexx=$result['vic_sex'];
				$vic_addresss=$result['vic_address'];			

				echo "<p class='p_margin_stat2'>"."<strong>ПІП постраждалого: &emsp;</strong>".$vic_pipp."<br/><br/>"."<strong>Дата народження: &emsp;</strong>".$vic_birthh."<br/><br/>"."<strong>Стать: &emsp;</strong>".$vic_sexx."<br/><br/>"."<strong>Адреса проживання: &emsp;</strong>".$vic_addresss."</p>";
			}
			?>
